...
dz       = [0.0472 0.049 0.05 0.05 0.05];
...
rds_snw(1:nbr_lyr) = [0,0,305,335,401];
...
rds_coated(1:nbr_lyr) = ["486_5","300_3","0","0","0"];
...
nbr_aer = 15;
    ...
    for x = 40000   % for reference: 1e6 = 1ug/g (1000000 ppb or 1000 ppm)
