...
dz       = [0.044 0.0498 0.05 0.05 0.05];
...
rds_snw(1:nbr_lyr) = [0,0,423,460,562];
...
rds_coated(1:nbr_lyr) = ["620_6","357_4",0,0,0];
...
nbr_aer = 15;
    ...
    for x = 1.6e5   % for reference: 1e6 = 1ug/g (1000000 ppb or 1000 ppm)
