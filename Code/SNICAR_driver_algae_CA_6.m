...
dz       = [0.042 0.0497 0.05 0.05 0.05];
...
rds_snw(1:nbr_lyr) = [0,0,493,531,676];
...
rds_coated(1:nbr_lyr) = ["695_7","384_4","0","0","0"];
...
nbr_aer = 15;
    ...
    for x = 3.2e5   % for reference: 1e6 = 1ug/g (1000000 ppb or 1000 ppm)
