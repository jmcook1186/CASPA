...
dz       = [0.0456 0.0499 0.05 0.05 0.05];
...
rds_snw(1:nbr_lyr) = [0,0,360,394,472];
...
rds_coated(1:nbr_lyr) = ["553_6","329_3",0,0,0];
...
nbr_aer = 15;
    ...
    for x = 80000   % for reference: 1e6 = 1ug/g (1000000 ppb or 1000 ppm)
