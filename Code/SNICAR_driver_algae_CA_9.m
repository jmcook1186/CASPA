...
rds_snw(1:nbr_lyr) = [0,0,728,765,1193];
...
rds_coated(1:nbr_lyr) = ["965_10","474_5","0","0","0"];
...
nbr_aer = 15;
    ...
    for x = 2.56e6   % for reference: 1e6 = 1ug/g (1000000 ppb or 1000 ppm)
