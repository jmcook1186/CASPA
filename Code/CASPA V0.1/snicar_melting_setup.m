...
mss_cnc_Real_Bio1(1:nbr_lyr)  = [0,0,0,0,0];    % Biological impurity species 7
...
fl_Real_Bio1 = 'Real_Bio_1.nc'; % Bio impuroity with measured pig profile inc phenol, 20 micron diam
