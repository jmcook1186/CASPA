...
function [new_r, new_f_refs, new_T, new_fliqs, dz] = snicar_melting_setup(BND_TYP, DIRECT, APRX_TYP, DELTA, coszen, R_sfc, dz, rho_snw, rds_snw, rds_coated, x, initial_T, fliqs, f_refs)
...
fliqs = fliqs(:);
% initial refrozen ice fraction per layer
f_refs = f_refs(:);
